...
import br.com.zenix.core.spigot.player.detection.events.AsyncPreDamageEvent;
...
public class DamageManager extends GladiatorListener {

	public static HashMap<Material, Double> damageMaterial = new HashMap<>();
